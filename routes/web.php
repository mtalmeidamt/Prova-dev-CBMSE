...
|
*/
//Route::get('/contato/show/{id}', [ContatoController::class, 'create'])->name('contato.show');
...
//Route::delete('/pessoa/{id}/destroy', [PessoaController::class, 'destroy'])->name('pessoa.destroy');
